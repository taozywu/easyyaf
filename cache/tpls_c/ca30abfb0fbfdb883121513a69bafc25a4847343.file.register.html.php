<?php /* Smarty version Smarty-3.1.7, created on 2016-05-25 23:11:59
         compiled from "D:\wnmp\nginx\html\muying\easyyaf/app/views\modules\index\register.html" */ ?>
<?php /*%%SmartyHeaderCode:130655745c0bf834ee9-25375345%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca30abfb0fbfdb883121513a69bafc25a4847343' => 
    array (
      0 => 'D:\\wnmp\\nginx\\html\\muying\\easyyaf/app/views\\modules\\index\\register.html',
      1 => 1464188904,
      2 => 'file',
  ...
  'nocache_hash' => '130655745c0bf834ee9-25375345',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5745c0bf838d6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5745c0bf838d6')) {function content_5745c0bf838d6($_smarty_tpl) {?><div class="wrapper site-header clearfix">
    ...
    <div class="float-right site-account">
            <div class="float-left site-login"><a class="white" href="http://www.haodian8.com/account/login?returnurl=%2faccount%2fregister%3freturnurl%3d%252fproduct%252flist%252f50549530" style="height: 46px;">登录</a></div>
    <div class="float-right site-register"><a class="white" href="http://www.haodian8.com/account/register?returnurl=%2faccount%2fregister%3freturnurl%3d%252fproduct%252flist%252f50549530" style="height: 46px;">注册</a></div>
...
<!-- 注册 -->
<form action="http://www.haodian8.com/account/register?returnurl=%2fproduct%2flist%2f50549530" method="post" novalidate="novalidate"><input name="__RequestVerificationToken" type="hidden" value="wE1BfIu2IRoHvEhLD2k3TY5AZ8dd-AjhtPKJkmKxfi_y2Zkc3aUAKc8eDffjVnz8-PuMswBSJCc0u3eV2sYzDg2TWkKku6DYxtUZYdAAkUo1">    <div class="wrapper page-account">
        <h1>- 注册 好店8 -</h1>
        <div class="page-account-content">
            <div class="page-account-content-left float-left">
                <table>
                    <tbody><tr>
                        <td>
                            <input class="txt" data-val="true" data-val-length="用户名 必须至少包含 2 个字符。" data-val-length-max="100" data-val-length-min="2" data-val-remote="该用户名已经存在" data-val-remote-additionalfields="*.UserName" data-val-remote-url="/Account/CheckUserName" data-val-required="用户名不能为空" id="UserName" name="UserName" placeholder="用户名" type="text" value="">
                            <span class="field-validation-valid" data-valmsg-for="UserName" data-valmsg-replace="true"></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input class="txt" data-val="true" data-val-regex="请输入正确的email" data-val-regex-pattern="" data-val-remote="该邮箱已经存在" data-val-remote-additionalfields="*.Email" data-val-remote-url="/Account/CheckEmail" data-val-required="Email 字段是必需的。" id="Email" name="Email" placeholder="Email 地址" type="text" value="">
                            <span class="field-validation-valid" data-valmsg-for="Email" data-valmsg-replace="true"></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input class="txt" data-val="true" data-val-length="密码由6到20个字符或数字组成。" data-val-length-max="20" data-val-length-min="6" data-val-required="密码不能为空" id="Password" name="Password" placeholder="密码" type="password">
        ...
        <div class="page-account-more">
            <p>
                已经有一个账号了？<a href="http://www.haodian8.com/account/login">请登录</a>
            </p>
        </div>
    </div>
</form>
